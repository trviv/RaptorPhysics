...
bool ImageIO::loadFile(const char *nameWithoutExtension, Texture *texture)
{
  int imageWidth = 0;
  int imageHeight = 0;
  int comp;
...
bool ImageIO::loadFile(const char *nameWithoutExtension, Texture *texture, uint resizeWidth, uint resizeHeight)
{
  int imageWidth = 0;
  int imageHeight = 0;
  int comp;
