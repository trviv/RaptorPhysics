...
#define minComp3(vec)       min(min(vec.x, vec.y), vec.z)
#define maxComp3(vec)       max(max(vec.x, vec.y), vec.z)
...
#define asFloat3(x)         as_type<float3>(x)
...
#define minComp3(vec)       min3(vec.x, vec.y, vec.z)
#define maxComp3(vec)       max3(vec.x, vec.y, vec.z)
